...
def compute_cache_key(report_type: str, start_date: str, end_date: str, export_format: str) -> str:
    key_str = f"{report_type}_{start_date}_{end_date}_{export_format}"
    return hashlib.sha256(key_str.encode("utf-8")).hexdigest()

def get_cached_report(report_type: str, start_date: str, end_date: str, export_format: str) -> str | None:
